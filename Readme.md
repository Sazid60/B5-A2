...
1. নির্দিষ্ট রো সিলেক্ট করা
   ...
   - যেই রো-এর id ফিল্ডে মান 1 আছে, শুধুমাত্র সেটিই রিটার্ন করবে।
...
2. কোনো একটি নির্দিষ্ট মানের উপর ভিত্তি করে ফিল্টার
   ...
   - যেসব রো-এর status ফিল্ডে 'active' আছে, সেগুলো দেখাবে।
...
3. মাল্টিপল শর্তে ফিল্টার করা
   ...
   - age 18 এর বেশি এবং city ‘Dhaka’ – দুই শর্তই পূরণ হলে সেই রো দেখাবে।
...
4. রেঞ্জের মধ্যে ডেটা সিলেক্ট করা
   ...
   - যেসব salary ৩০,০০০ থেকে ৬০,০০০ এর মধ্যে, সেগুলো রিটার্ন করবে।
...
5. একাধিক মানের মধ্যে যেকোনো একটি মিললে
   ...
   - যেসব role ফিল্ডের মান ‘admin’, ‘editor’ অথবা ‘manager’, সেগুলো দেখাবে।
...
6. একটি নির্দিষ্ট কলামে মান নেই
   ...
   - যেসব রো-তে deleted_at ফিল্ড ফাঁকা বা null, সেগুলো রিটার্ন করবে।
...
7. LIKE দিয়ে আংশিক ম্যাচ করা
   ...
   - name ফিল্ডে যেকোনো স্থানে ‘SAZID’ আছে এমন রো গুলো দেখাবে।
...
8. NOT দিয়ে মান বাদ দেওয়া
   ...
   - department ফিল্ডে যেসব রো ‘HR’ নয়, সেগুলো দেখাবে।
...
9. IS NOT NULL ব্যবহার করে যেসব ডেটা পূর্ণ
   ...
   - যেসব রো-তে email ফিল্ডে কিছু না কিছু আছে, ফাঁকা না, সেগুলো দেখাবে।
...
10. DATE এর উপর ফিল্টার
    ...
    - আজকের তারিখের আগের যেসব ডেটা created_at ফিল্ডে আছে, সেগুলো রিটার্ন করবে।
